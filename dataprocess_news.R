...
while (iterate){
  ...
  writedata(dictionary, interatorindex,"dicnews")
  writedata(ngram, interatorindex,"fivegramnews")
...
dictionary <- readdata(1,"dicnews")

for (i in 2:Maxfiles){
  temp  <- readdata(i,"dicnews")
...
writedata(x=dictionary,file="dictionary_news.dat")
...
writedata(x=final_dictionary, file="final_dictionary_news.dat")
writedata(x=wordstodeleteNgram, file="wordstodeleteNgram_news.dat")
...
writedata(x=mergedngram,file="news_merged5gram.dat")
